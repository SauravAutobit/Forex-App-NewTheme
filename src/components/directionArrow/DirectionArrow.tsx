...
const DirectionArrow = ({ className }: { className?: string }) => {
  return (
    <div
      className={`relative flex items-end group pointer-events-none ${className}`}
    >
      <div className="text-white text-lg leading-tight text-center w-[173px] h-[20px] max-w-[173px] ">
        Tap on Trade to <br />
      ...
      <img
        src={directionArrow}
        alt="directionArrow"
        className="w-[86.5px] h-[119px] object-contain"
      />
    </div>
  );
};
