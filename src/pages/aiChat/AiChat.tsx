...
//           style={{ background: theme === "dark" ? "#25262F" : "#E9E9E9" }}
//           onClick={() =>
//             dispatch(sendPromptToAI("Monthly Profit of my portfolio"))
//           }
//         >
//           Monthly Profit <span className="text-secondary">of my portfolio</span>
//         </button>
...
//         >
//           Performance of <span className="text-secondary">last week</span>
//         </button>
...
//         >
//           Best performing <span className="text-secondary">asset</span>
//         </button>
//       </div>
...
//               className="flex-1 px-3 py-3 h-[42px] text-primary rounded-full outline-none"
//               style={{ background: theme === "dark" ? "#25262F" : "#E9E9E9" }}
